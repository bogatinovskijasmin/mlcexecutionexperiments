    ...
    for cost in setOfParameters['C']:
        for gamma in setOfParameters['G']:
            ...
            clf = Meka(
                ...
                weka_classifier = 'weka.classifiers.functions.SMO -- -L 0.001 -M -P 1.0E-12 -N 0 -V -1 -W 1 ' + parametarizationC + ' -K \"weka.classifiers.functions.supportVector.RBFKernel ' + parametarizationGamma + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8 -num-decimal-places 4\"',
    ...
    for cost in setOfParameters['C']:
        for gamma in setOfParameters['G']:
            ...
            clf = Meka(
                    ...
                    weka_classifier = 'meka.classifiers.multilabel.BR -- -W weka.classifiers.functions.SMO -- -L 0.001 -M -P 1.0E-12 -N 0 -V -1 -W 1 ' + parametarizationC + ' -K \"weka.classifiers.functions.supportVector.RBFKernel ' + parametarizationGamma + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8  -num-decimal-places 4\"',
                    meka_classpath = mekaPath,
                    java_command = javaPath)
            d["provides_probabilites"] = "YES"
        ...
        for cost in setOfParameters['C']:
            for gamma in setOfParameters['G']:
                ...
                clf = Meka(
                    ...
                    weka_classifier='meka.classifiers.multilabel.CC -- -W weka.classifiers.functions.SMO -- -L 0.001 -M -P 1.0E-12 -N 0 -V -1 -W 1 ' + parametarizationC + ' -K \"weka.classifiers.functions.supportVector.RBFKernel ' + parametarizationGamma + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8  -num-decimal-places 4\"',
                    meka_classpath = mekaPath,
                    java_command = javaPath)
                d["provides_probabilites"] = "YES"
                ...
                d["family methods"] = "problem transformations"
                d["language"] = "JAVA"
                d["command"] = 'meka.classifiers.multilabel.meta.EnsembleML -W meka.classifier.multilabel.CC'
                d["method_parameters"] = {"-threshold": "PCut1",
                                          "-S": str(1),
                                          "-P": str(70),
                                          "-I": str(iterators),
    ...
    for iterators in setOfParameters['I']:
        for cost in setOfParameters['C']:
            for gamma in setOfParameters['G']:
                ...
                clf = Meka(
                    meka_classifier = 'meka.classifiers.multilabel.meta.BaggingMLdup -threshold "PCut1" -S 1 -P 100 -I '+str(iterators),
                    weka_classifier='meka.classifiers.multilabel.LC -- -W weka.classifiers.functions.SMO -- -L 0.001 -M -P 1.0E-12 -N 0 -V -1 -W 1 ' + parametarizationC + ' -K \"weka.classifiers.functions.supportVector.RBFKernel ' + parametarizationGamma + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8  -num-decimal-places 4\"',
                    meka_classpath = mekaPath,
                    java_command = javaPath)
                d["provides_probabilites"] = "YES"
    ...
    for cost in setOfParameters['C']:
        for gamma in setOfParameters['G']:
            ...
            clf = Meka(
                ...
                weka_classifier = 'weka.classifiers.functions.SMO -- -L 0.001 -P 1.0E-12 -M -N 0 -V -1 -W 1 ' + parametarizationC + ' -K \"weka.classifiers.functions.supportVector.RBFKernel ' + parametarizationGamma + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8 -num-decimal-places 4\"',
                meka_classpath = mekaPath,
                java_command = javaPath)
            d["provides_probabilites"] = "YES"
    ...
    for cost in setOfParameters['C']:
        for gamma in setOfParameters['G']:
            ...
            clf = Meka(
                ...
                weka_classifier = 'weka.classifiers.functions.SMO -- -L 0.001 -P 1.0E-12 -N 0 -V -M -W 1 ' + parametarizationC + ' -K \"weka.classifiers.functions.supportVector.RBFKernel ' + parametarizationGamma + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8 -num-decimal-places 4\"',
                meka_classpath = mekaPath,
                java_command = javaPath)
                ...
                for cost in setOfParamteres["C"]:
                    for gamma in setOfParamteres["G"]:
                        ...
                        clf = Meka(
                            ...
                            weka_classifier = 'weka.classifiers.functions.SMO -- -L 0.001 -P 1.0E-12 -N 0 -V -M  -W 1 -C ' + str(cost) + ' -K \"weka.classifiers.functions.supportVector.RBFKernel -G ' + str(gamma) + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8  -num-decimal-places 4\"',
                            meka_classpath = mekaPath,
                            java_command = javaPath)
                        d["provides_probabilites"] = "YES"
    ...
    for cost in setOfParameters["cost"]:
        for gamma in setOfParameters["gamma"]:
                    ...
                    clf = Meka(
                        ...
                        weka_classifier='weka.classifiers.functions.SMO -- -L 0.001 -P 1.0E-12 -N 0 -V -1 -W 1 -M -C ' + str(cost) + ' -K \"weka.classifiers.functions.supportVector.RBFKernel -G ' + str(gamma) + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8 -num-decimal-places 4\"',
        ...
        for gamma in setOfParameters["gamma"]:
            for k in setOfParameters["labelSubspaceSize"]:
                for pv in setOfParameters["pruningValue"]:
                    q = 0
                    d = {}
                    if setOfParameters["methodName"] in ["mediamill", "bookmarks", "delicious"]:
                        numberModels = 10
                    else:
    ...
    for cost in setOfParameters['C']:
        for gamma in setOfParameters['G']:
            ...
            clf = Meka(
                ...
                weka_classifier = 'weka.classifiers.functions.SMO -- -L 0.001 -P 1.0E-12 -N 0 -V -1 -W 1 -M ' + parametarizationC + ' -K \"weka.classifiers.functions.supportVector.RBFKernel ' + parametarizationGamma + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8 -num-decimal-places 4\"',
                meka_classpath = mekaPath,
                java_command = javaPath)
...
def BRkNearestNeighbour(setOfParameters):
    ...
    for k in setOfParameters["k"]:
        ...
        d = {}
        d["provides_probabilites"] = "provides probabilites"
...
def CostSensitiveLabelEmbedding(setOfParameters):
    configurations = []
    for k in setOfParameters["k"]:
        clf = EmbeddingClassifier(embedder=CLEMS(jaccard_similarity_score, True), regressor=RandomForestRegressor(n_estimators=100, max_features="sqrt"), classifier=MLkNN(k=k), regressor_per_dimension=True)
        d = {}
        d["provides_probabilites"] = "YES"
        ...
        d["method_parameters"] = {"k_number_of_neighbours": str(k),
                                  ...
                                  "embedder":"CLEMS"}
        configurations.append((clf, "CLMES_embedding_with_random_forest_regression_100_estimators_and_MlKNN_classifier_k_"+str(k), d))
    return configurations
        ...
        for attributes in setOfParameters["attributes"]:
            for cost in setOfParameters["cost"]:
                for gamma in setOfParameters["gamma"]:
                    ...
                    clf = Meka(
                        meka_classifier='meka.classifiers.multilabel.meta.RandomSubspaceML -threshold "PCut1" -P 67 -S 0 -A ' + str(attributes) + ' -I ' + str(iterations)+ ' ',
                        weka_classifier='meka.classifiers.multilabel.LC -- -W weka.classifiers.functions.SMO -- -L 0.001 -P 1.0E-12 -N 0 -V -1 -W 1 -M -C ' + str(cost) + ' -K \"weka.classifiers.functions.supportVector.RBFKernel -G ' + str(gamma) + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8 -num-decimal-places 4\"',
                        meka_classpath=mekaPath,
                        java_command=javaPath)
    ...
    for cost in setOfParameters["cost"]:
        for gamma in setOfParameters["gamma"]:
            for k in setOfParameters["clusters"]:
                ...
                weka_classifier = 'weka.classifiers.functions.SMO -- -L 0.001 -P 1.0E-12 -N 0 -V -1 -W 1 -C ' + str(cost) + ' -K \"weka.classifiers.functions.supportVector.RBFKernel -G ' + str(gamma) + ' -C 250007\" \"-calibrator\" \"weka.classifiers.functions.Logistic -R 1.08E-8 -num-decimal-places 4\"',
                meka_classpath=mekaPath,
                java_command=javaPath)
...
def ConditionalDependencyNetwork(setOfParameters):
    ...
    for iterations in setOfParameters["I"]:
        for collectionIterations in setOfParameters["Ic"]:
            ...
            d["provides_probabilites"] = "YES"
            d["method_name"] = "ConditionalDependencyNetwork"
            d["library"] = "MEKA"
            d["language"] = "JAVA"
            d["command"] = 'meka.classifiers.multilabel.CDN'
            d["family methods"] = "problem transformations"
            d["method_parameters"] = {"-threshold": "PCut1",
                                      "-I": str(iterations),
...
def DEEP1(inptuDimension, numberTargets, trainDataPath, testDataPath):
    configurations = []
    d = {}

    nHidden = int(inptuDimension/5)
    nOut = int(numberTargets)
    l_r  = 0.1
    mom = 0.8

    clf = "/usr/bin/java -cp \"" + mekaPath + "*\" meka.classifiers.multilabel.meta.DeepML -threshold \"PCut1\" -N 2 -H " + str(nHidden) + " -E 100 -r " + str(l_r) + " -m " + str(mom) + " -verbosity 8 -t " + trainDataPath + " -T " + testDataPath + " -W meka.classifiers.multilabel.BPNN -- -H " + str(nHidden) + " -E 100 -r " + str(l_r) + " -m " + str(mom) + " "
    ...
    d["library"] = "MEKA"
    d["language"] = "JAVA"
    d["command"] = 'meka.classifiers.multilabel.DBPNN'
    d["method_parameters"] = {"-threshold": "PCut1",
                              "-m": str(mom),
                              "-H": str(nHidden),
                              "-E": str(1000),
    ...
    configurations.append((clf, "DBPNN1_hidden_units_" + str(nHidden) + "_epoaches_" + str(150) + "_learning_rate_"+str(l_r).replace(".", "__"), d))  # use J48 beacause it is easier to be trained
    return configurations



def DEEP2(inptuDimension, numberTargets, trainDataPath, testDataPath):
    configurations = []
    d = {}
    ...
    configurations.append((clf, "DBPNN2_hidden_units_" + str(nHidden) + "_epoaches_" + str(150) + "_learning_rate_"+str(l_r).replace(".", "__"), d))  # use J48 beacause it is easier to be trained
    return configurations
...
def DEEP3(inptuDimension, numberTargets, trainDataPath, testDataPath):
    configurations = []
    d = {}
    ...
    clf = "/usr/bin/java -cp \"" + mekaPath + "*\" meka.classifiers.multilabel.meta.DeepML -threshold \"PCut1\" -N 2 -H " + str(nHidden) +  " -E 100 -r " + str(l_r) + " -m " + str(mom) + " -verbosity 8 -t " + trainDataPath + " -T " + testDataPath + " -W meka.classifiers.multilabel.meta.BaggingML -- -I 50 -W meka.classifiers.multilabel.CC  -- -W weka.classifiers.functions.SMO -- -C 1 -K \"weka.classifiers.functions.supportVector.RBFKernel -G 0.01\""
    ...
    d["method_parameters"] = {"-threshold": "PCut1",
                              ...
                              "MLL_base": {"name": "ECC",
                                        "iterators": str(10),
                                         "baseMethodName": 'weka.classifiers.trees.SMO',
                                                                          "parameters": {"-C": str(1),
                                                                           "-G": "0.01"}
                              }
                              }

    configurations.append((clf, "DBPNN3_hidden_units_" + str(nHidden) + "_epoaches_" + str(150) + "_learning_rate_"+str(l_r).replace(".", "__"), d))  # use J48 beacause it is easier to be trained
    return configurations




def DEEP4(inptuDimension, numberTargets, trainDataPath, testDataPath):
    configurations = []
    d = {}
    ...
    d["method_parameters"] = {"-threshold": "PCut1",
                              ...
                              "MLL_base": {"name": "ECC",
                                         "iterators": str(10),
                                         "baseMethodName": 'weka.classifiers.trees.SMO',
                                          "parameters": {"-C": str(1),    "-G": "0.01"}

                                           }
                              }


    configurations.append((clf, "DBPNN4_hidden_units_" + str(nHidden) + "_epoaches_" + str(150) + "_learning_rate_"+str(l_r).replace(".", "__"), d))  # use J48 beacause it is easier to be trained
    return configurations

#java -cp "./lib/*" meka.classifiers.multilabel.meta.DeepML -threshold "PCut1" -N 2 -H 37 -E 1000 -r 0.8 -m 0.1 -verbosity 8 -t data/ABPM_train.arff -T data/ABPM_test.arff  -W meka.classifiers.multilabel.meta.BaggingML -- -I 10 -W meka.classifiers.multilabel.CC  -- -W weka.classifiers.functions.SMO -- -C 1 -K "weka.classifiers.functions.supportVector.RBFKernel -G 0.01"